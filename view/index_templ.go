	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(commandTemplates) == 0 {
				...
				if user == nil {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<a id=\"advise-button-login\" class=\"advise-button\">Войдите</a> или <a id=\"advise-button-reg\" class=\"advise-button\">зарегистрируйтесь</a><script>\r\n\t\t\t\t\t\t\t\taddOpenableBlockListeners(\".login_block\", \"#advise-button-login\", \"#login_content\");\r\n\t\t\t\t\t\t\t\taddOpenableBlockListeners(\".reg_block\", \"#advise-button-reg\", \"#reg_content\");\r\n\t\t\t\t\t\t\t\taddFocusListeners(\"#advise-button-login\", \"#login_button\");\r\n\t\t\t\t\t\t\t\taddFocusListeners(\"#advise-button-reg\", \"#reg_button\");\r\n\t\t\t\t\t\t\t</script>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<a class=\"advise-button\" href=\"/create\">Создайте</a> свой первый шаблон")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "</div><div class=\"command-templates\"><h2 class=\"body-title templates-title\">Шаблоны</h2>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
